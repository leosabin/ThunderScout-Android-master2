...
public class AverageTeamInfoFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView defense = (RecyclerView) view.findViewById(R.id.info_average_summaryDefense);

        defense.setLayoutManager(new LinearLayoutManager(getContext()));
        defense.setAdapter(new CommentsAdapter(data.getDefensesList()));
    }
}
